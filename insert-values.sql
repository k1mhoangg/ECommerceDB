...
('DM1','Điện tử','Thiết bị điện tử'),
('DM2','Thời trang','Quần áo và phụ kiện'),
('DM3','Gia dụng','Đồ dùng gia đình'),
('DM4','Sách','Sách và văn phòng phẩm'),
('DM5','Làm đẹp','Mỹ phẩm và chăm sóc');
GO
...
('NM1','Buyer One','bpw1','active','Nam','1990-01-01','b1@example.com','0123456781'),
('NM2','Buyer Two','bpw2','active','Nu','1991-02-02','b2@example.com','0123456782'),
('NM3','Buyer Three','bpw3','active','Nam','1992-03-03','b3@example.com','0123456783'),
('NM4','Buyer Four','bpw4','active','Nu','1993-04-04','b4@example.com','0123456784'),
('NM5','Buyer Five','bpw5','active','Nam','1994-05-05','b5@example.com','0123456785');
GO
...
('SP1','NB1','Điện thoại A','Smartphone A','5M-7M','img1.jpg','DM1'),
('SP2','NB2','Áo thun B','Áo cotton','199K-399K','img2.jpg','DM2'),
('SP3','NB3','Ấm siêu tốc C','Ấm điện','200K-500K','img3.jpg','DM3'),
('SP4','NB4','Sách D','Tiểu thuyết','50K-150K','img4.jpg','DM4'),
('SP5','NB5','Son E','Son môi','100K-300K','img5.jpg','DM5');
GO
...
('BT1','SP1','bt1.jpg','Đen',0.18,5000.00,10,'N/A',4500.00),
('BT2','SP2','bt2.jpg','Trắng',0.12,200.00,50,'M',180.00),
('BT3','SP3','bt3.jpg','Xám',0.80,300.00,20,'N/A',270.00),
('BT4','SP4','bt4.jpg','N/A',0.35,120.00,100,'N/A',110.00),
('BT5','SP5','bt5.jpg','Đỏ',0.02,150.00,40,'N/A',130.00);
GO

-- 31) kho (5)
INSERT INTO kho (ma_kho, tinh_trang, suc_chua, dia_chi) VALUES
('KHO1','Sẵn sàng',1000,'Kho A'),
('KHO2','Sẵn sàng',800,'Kho B'),
('KHO3','Bảo trì',500,'Kho C'),
('KHO4','Sẵn sàng',1200,'Kho D'),
('KHO5','Sẵn sàng',600,'Kho E');
GO
...
('DV2','Giao hàng B'),
('DV3','Giao nhanh C'),
('DV4','Giao tiết kiệm D'),
('DV5','Giao Express E');
GO

-- 29) shipper (5)
INSERT INTO shipper (ma_shipper, cccd, ngay_sinh, gioi_tinh, so_dien_thoai, ten) VALUES
('SH1','900000001','1990-06-01','Nam','0987000001','Shipper One'),
('SH2','900000002','1991-07-02','Nu','0987000002','Shipper Two'),
('SH3','900000003','1992-08-03','Nam','0987000003','Shipper Three'),
('SH4','900000004','1993-09-04','Nu','0987000004','Shipper Four'),
('SH5','900000005','1994-10-05','Nam','0987000005','Shipper Five');
GO
...
('DH1','2025-06-01',3000.00,'Giao vien A',1,'Giao tiêu chuẩn','Người nhận 1','2025-05-01 10:00:00','Đang xử lý',5000.00,1,'PT1','AC1','Bank A'),
('DH2','2025-06-02',2000.00,'Giao vien B',0,'Thanh toán online','Người nhận 2','2025-05-02 11:00:00','Đang xử lý',400.00,2,'PT2','AC2','Bank B'),
('DH3','2025-06-03',2500.00,'Giao vien C',1,'Giao nhanh','Người nhận 3','2025-05-03 12:00:00','Hoàn thành',300.00,1,'PT3','AC3','Bank C'),
('DH4','2025-06-04',1500.00,'Giao vien D',0,'Giao tiết kiệm','Người nhận 4','2025-05-04 13:00:00','Đang giao',360.00,3,'PT4','AC4','Bank D'),
('DH5','2025-06-05',1000.00,'Giao vien E',1,'Giao tối ưu','Người nhận 5','2025-05-05 14:00:00','Đã giao',150.00,1,'PT5','AC5','Bank E');
GO
...
('KG1','DH1','KHO1','2025-05-02 09:00:00','Nhận'),
('KG2','DH2','KHO2','2025-05-03 10:00:00','Xếp'),
('KG3','DH3','KHO3','2025-05-04 11:00:00','Gửi'),
('KG4','DH4','KHO4','2025-05-05 12:00:00','Nhận'),
('KG5','DH5','KHO5','2025-05-06 13:00:00','Gửi');
GO
...
('KG1','DH1','SH1','2025-05-02 14:00:00','Giao'),
('KG2','DH2','SH2','2025-05-03 15:00:00','Giao'),
('KG3','DH3','SH3','2025-05-04 16:00:00','Giao'),
('KG4','DH4','SH4','2025-05-05 17:00:00','Giao'),
('KG5','DH5','SH5','2025-05-06 18:00:00','Giao');
GO
...
('DG1',5,'dg1.jpg',NULL,'Tuyệt vời','2025-05-10 10:00:00','Chi tiết 1','DH1',1,'BT1','SP1'),
('DG2',4,'dg2.jpg',NULL,'Ok','2025-05-11 11:00:00','Chi tiết 2','DH2',1,'BT2','SP2'),
('DG3',3,'dg3.jpg',NULL,'Bình thường','2025-05-12 12:00:00','Chi tiết 3','DH3',1,'BT3','SP3'),
('DG4',5,'dg4.jpg',NULL,'Rất tốt','2025-05-13 13:00:00','Chi tiết 4','DH4',1,'BT4','SP4'),
('DG5',4,'dg5.jpg',NULL,'Hài lòng','2025-05-14 14:00:00','Chi tiết 5','DH5',1,'BT5','SP5');
GO
...
(1,'NM1','0123456781','Người nhận 1','Địa chỉ 1'),
(1,'NM2','0123456782','Người nhận 2','Địa chỉ 2'),
(1,'NM3','0123456783','Người nhận 3','Địa chỉ 3'),
(1,'NM4','0123456784','Người nhận 4','Địa chỉ 4'),
(1,'NM5','0123456785','Người nhận 5','Địa chỉ 5');
GO
...
('NB1','NM1','Hỏi về sản phẩm','2025-05-01 09:00','2025-05-01 09:05'),
('NB2','NM2','Chưa nhận hàng','2025-05-02 10:00','2025-05-02 10:10'),
('NB3','NM3','Đổi trả','2025-05-03 11:00','2025-05-03 11:15'),
('NB4','NM4','Yêu cầu bảo hành','2025-05-04 12:00','2025-05-04 12:20'),
...
-- 33 (already inserted), 27 (viet_danh_gia inserted), 10 inserted.

-- 36) (none) -- All 35 tables covered.

PRINT 'Inserted 5 rows per table (1..35).';
GO
